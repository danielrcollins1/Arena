...
public class Wands {
	...
	private static final String WANDS_FILE = "Wands.csv";

	//--------------------------------------------------------------------------
	//  Inner class
	//--------------------------------------------------------------------------

	/** Class for info on one type of wand. */
	class WandInfo {

		/** Name of the wand. */
		private String name;
		
		/** Power tier of the wand. */
		private int tier;
	...
	private static Wands instance = null;

	/** Table of wand information. */
	private WandInfo[] wandList;
