...
public class TreasureType {
    ...
    private final TreasureCategory copper;
    private final TreasureCategory silver;
    private final TreasureCategory gold;
    private final TreasureCategory gems;
    private final TreasureCategory jewelry;
