...
public class MonsterTreasureTable {
    ...
    /**
     * Array of net.superdan.athena.TreasureType records.
     */
    private final TreasureType[] treasureTable;
	...
	public static MonsterTreasureTable getInstance() {
		if (instance == null) {
            try {
                ...
                System.out.println("Failed to read the net.superdan.athena.Monster Treasure file.");
            }
		}
		return instance;
	}
	...
	*/
    ...
    public static void main(String[] args) {
        ...
        System.out.println("net.superdan.athena.Monster Treasure Table");
