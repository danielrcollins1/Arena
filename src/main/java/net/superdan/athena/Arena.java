...
/******************************************************************************
 *  net.superdan.athena.Arena of battling fighters (as gladiators).
 *
...
public class Arena {
	...
	*/
	void printBanner () {
		System.out.println("OED net.superdan.athena.Arena Simulator");
		System.out.println("-------------------");
	}
	...
	*/
	public void printUsage () {
		System.out.println("Usage: net.superdan.athena.Arena [options]");
	...
	void fightDuelsManVsMan () {
		for (int i = 0; i < fighterList.size() - 1; i += 2) {
			...
			if (reportEveryEncounter) {
				System.out.println("net.superdan.athena.Arena event: "
						+ party1 + " vs. " + party2);
			}
	...
	*/
	void reportTotalMonsterKills () {
		...
		System.out.println("Total net.superdan.athena.Monster Kills");
		System.out.println("-------------------");
