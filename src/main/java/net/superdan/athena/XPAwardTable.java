...
public class XPAwardTable {
     ...
     * Array of XPRecords.
     */
    private final XPAwardRecord[] xpAwardRecordArray;
	...
	*/
	public static XPAwardTable getInstance() {
		if (instance == null) {
            try {
                ...
                System.err.println("Failed to read the net.superdan.athena.XPAwardTable file.");
            }
        }
        return instance;
    }
     ...
     * net.superdan.athena.Monster xpBonuses give special addition each.
     */
	...
	*/
	public static void main(String[] args) {
        ...
        System.out.println("net.superdan.athena.Monster XP Awards");
