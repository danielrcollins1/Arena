...
/******************************************************************************
 *  net.superdan.athena.Armor on a character.
 *
...
public class Armor extends Equipment {
    ...
    static public Armor makeType(Type type) {
        switch (type) {
            case Plate:
                return new Armor(type, 6, 4);
            case Chain:
                return new Armor(type, 4, 2);
            case Leather:
                return new Armor(type, 2, 1);
            case Shield:
                return new Armor(type, 1, 1);
            default:
                System.err.println("net.superdan.athena.Armor type has undefined values.");
                return null;
        }
    }
}
