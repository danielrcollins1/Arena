	...
	*/
	public void writePDF (Character c) {
		try {
			...
			// Identifiers
			form.getField("net.superdan.athena.Character").setValue(c.getName());
			form.getField("RaceClass").setValue(c.getRaceClassDesc());
			form.getField("net.superdan.athena.Alignment").setValue(c.getAlignment().toString());
			...
			while (atkNum < NUM_ATTACK_LINES) {
				...
				form.getField("net.superdan.athena.Weapon" + atkNum).setValue(atk.getName());
