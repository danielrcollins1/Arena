...
public class Marshal {
    ...
    /**
     * net.superdan.athena.Dice for men number appearing, as per Vol-2.
     */
     ...
     */
    void printBanner() {
        System.out.println("OED net.superdan.athena.Marshal Program");
        System.out.println("-------------------");
    }
    ...
    public void printUsage() {
        System.out.println("Usage: net.superdan.athena.Marshal [options] menType [number]");
